...
const sampleLibraryItems: LibraryItem[] = [
  ...
  },
  {
    ...
    connections: [
      ...
      { id: 'motu-line3', name: 'Line Input 3', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line4', name: 'Line Input 4', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line5', name: 'Line Input 5', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line6', name: 'Line Input 6', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line7', name: 'Line Input 7', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line8', name: 'Line Input 8', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line9', name: 'Line Input 9', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      { id: 'motu-line10', name: 'Line Input 10', direction: 'input', physical: '1/4 TRS', category: 'balanced', way: 'socket' },
      ...
      // Line outputs (8x TRS)
      { id: 'motu-out3', name: 'Line Out 3', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out4', name: 'Line Out 4', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out5', name: 'Line Out 5', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out6', name: 'Line Out 6', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out7', name: 'Line Out 7', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out8', name: 'Line Out 8', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out9', name: 'Line Out 9', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
      { id: 'motu-out10', name: 'Line Out 10', direction: 'output', physical: '1/4 TRS', category: 'balanced', way: 'port' },
